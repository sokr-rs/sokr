...
| 3.2  | Specify version handshake protocol in TLA+ or Alloy | TLA+ spec in docs/formal-spec.tla with 4 invariants + 4 theorems; ready for TLC model checker verification | 3.1 | cc:done |
